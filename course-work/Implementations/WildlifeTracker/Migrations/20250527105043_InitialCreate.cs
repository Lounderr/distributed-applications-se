        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Animal_Age_Positive", "[Age] >= 0");
                    table.CheckConstraint("CK_Animal_Height_Positive", "[Height] > 0");
                    table.CheckConstraint("CK_Animal_Weight_Positive", "[Weight] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Size = table.Column<double>(type: "float(5)", precision: 5, scale: 2, nullable: false),
                    Climate = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AverageTemperature = table.Column<double>(type: "float(5)", precision: 5, scale: 2, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Habitat_Size_Positive", "[Size] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_AdultOnly", "DateOfBirth <= DATEADD(YEAR, -14, GETDATE())");
                    table.CheckConstraint("CK_User_DateOfBirth_MaxAge", "DateOfBirth >= DATEADD(YEAR, -120, CAST(GETDATE() AS DATE))");
                    table.CheckConstraint("CK_User_DateOfBirth_NotFuture", "DateOfBirth <= CAST(GETDATE() AS DATE)");
                    table.CheckConstraint("CK_User_PhoneNumber_E164", "PhoneNumber LIKE '+%' AND LEN(PhoneNumber) >= 2 AND LEN(PhoneNumber) <= 16 AND PhoneNumber NOT LIKE '%[^+0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeatherConditions = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sighting_SightingDateTime", "SightingDateTime <= GETDATE()");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sightings_Habitats_HabitatId",
                        column: x => x.HabitatId,
                        principalTable: "Habitats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sightings_Users_ObserverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sightings_HabitatId",
                table: "Sightings",
                column: "HabitatId");

            migrationBuilder.CreateIndex(
                name: "IX_Sightings_ObserverId",
                table: "Sightings",
                column: "ObserverId");
